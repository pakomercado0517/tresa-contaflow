 ...
 */
export const calcularEstadoPagoFactura = async (
  factura: Invoice,
  profileId: string
  ...
  if (factura.tipo === 'PPD') {
    return await calcularEstadoPPD(factura.uuid, factura.pagos, totalFactura, profileId);
  }
 ...
 */
export const calcularEstadoPagoGasto = async (
  ...
  if (gasto.tipo === 'PPD' && gasto.uuid) {
    return await calcularEstadoPPD(gasto.uuid, gasto.pagos, totalGasto, profileId);
  }
 ...
 */
export const calcularEstadoPPD = async (
  uuid: string,
 ...
 */
export const calcularEstadoPagoFacturas = async (
  facturas: Invoice[],
  profileId: string
 ...
 */
export const calcularEstadoPagoGastos = async (
 ...
 */
const calcularEstadoPPDConComplementos = (
  uuid: string,
  pagosManuales: PagoParcial[],
  totalFactura: number,
