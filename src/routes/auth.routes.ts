...
const registerValidation = [
  ...
  body('nombre').optional().trim().isString().withMessage('El nombre debe ser una cadena de texto'),
  body('apellido')
    .optional()
    .trim()
    .isString()
...
const resendVerificationEmailValidation = [body('email').isEmail().withMessage('Email inválido')];

const requestPasswordResetValidation = [body('email').isEmail().withMessage('Email inválido')];
...
const updateProfileValidation = [
  ...
  body('telefono')
    ...
    .isString()
    .withMessage('El teléfono debe ser una cadena de texto'),
  body('logo_url').optional().trim().isURL().withMessage('El logo_url debe ser una URL válida'),
...
router.post('/verify-email', verifyEmailValidation, validateRequest, verifyEmailController);
router.post(
